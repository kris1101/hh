...
export const SLOWQUERYGROUPDETAIL = "SLOWQUERYGROUPDETAIL"; //组详情
export const SLOWQUERYGROUPUPDATE = "SLOWQUERYGROUPUPDATE"; //组更新
...
//关系型数据库binlog日志信息获取操作
export const RDBINSTANCEBINLOGFETCH = 'RDBINSTANCEBINLOGFETCH'

//关系型数据库集群与实例关系操作
export const RDBCLUSTERINSTANCEREATIONSHIPFETCH = 'RDBCLUSTERINSTANCEREATIONSHIPFETCH'; //集群与实例关系数据获取
export const RDBCLUSTERINSTANCERELATIONSHIPUPDATE = "RDBCLUSTERINSTANCERELATIONSHIPUPDATE"; //集群与实例关系数据更新

//关系型数据库主机操作
export const RDBHOSTFETCH = "RDBHOSTFETCH"; //主机获取
export const RDBHOSTCREATE = "RDBHOSTCREATE"; //主机创建
export const RDBHOSTUPDATE = "RDBHOSTUPDATE"; //主机更新
export const RDBHOSTDELETE = "RDBHOSTDELETE"; //主机删除

//关系型数据库主机与实例操作
export const RDBHOSTINSTANCERELATIONSHIPFETCH = 'RDBHOSTINSTANCERELATIONSHIPFETCH'; //主机与实例关系数据获取
export const RDBHOSTINSTANCERELATIONSHIPUPDATE = 'RDBHOSTINSTANCERELATIONSHIPUPDATE'; //主机与实例关系数据更新
