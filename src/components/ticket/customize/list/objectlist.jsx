...
import ObjectModal from '../create/objectmodal'
      ...
      <Layout className="config">
        ...
        <Content style={{ padding: 0, margin:10, marginBottom: 0, minHeight: window.innerHeight-84 }}>
            ...
            <div style={{margin: 20}}>
             ...
             {
                this.state.isOpen && <ObjectModal hideModal={this.hideModal} isOpen={this.state.isOpen} modalType={this.state.modalType} currentData={this.state.currentData} />
            }
        </Content>
      </Layout>
    );
