...
import { getverifys } from './TableTpl/verify';
import './list.less';

const { Sider, Content } = Layout;
const FormItem = Form.Item;

class DaasVerifyManageForm extends Component {
    constructor(props) {
        super(props);
        this.columns = getverifys.call(this);
    }
    state = {
        deviceList: [],
        currentPage: 1,
    ...
    return (
      <Layout className="config">
        ...
        <Content style={{ padding: 0, margin:10, marginBottom: 0, minHeight: window.innerHeight-84 }}>
            <BreadcrumbCustom first="关系型数据库" second="sql审核" />
...
const DaasVerifyManage = Form.create()(DaasVerifyManageForm);
