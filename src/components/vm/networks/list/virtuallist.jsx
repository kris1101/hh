...
import { getvirtual } from './TableTpl/virtualtabletpl';
import './list.less';
...
class VMVirtualForm extends Component {
    constructor(props) {
        super(props);
        this.columns = getvirtual.call(this);
    }
    state = {
        deviceList: [],
        currentPage: 1,
    ...
    return (
      <Layout className="config">
        ...
        <Content style={{ padding: 0, margin:10,  marginBottom: 0, minHeight: window.innerHeight-84 }}>
            <BreadcrumbCustom first="虚拟机管理" second="虚拟网络" />
            <div className="form-search-box" style={{ background:'#fff',padding:10, }}>
                <Form layout="inline" onSubmit={this.handleSubmit}>
                    <FormItem>
                        <Button type="primary" onClick={(e) => this.openAddDevicePage('add',e)}>创建虚拟网络</Button>
                    </FormItem>
...
const VMVirtual = Form.create()(VMVirtualForm);
